  ...
  <el-container>
    <el-main class="query_info">
       <el-row class="button_list">
         <!-- 添加 -->
          <el-button type="primary"  @click="info_button" class="el-button el-button--primary el-button--small">修改</el-button>
          <el-dialog
              title="修改"
          ...
          <el-button class="el-button el-button--small gap" type="danger" @click="dialogVisible = true">作废</el-button>
          <el-dialog
              title="添加机构"
              :visible.sync="dialogVisible"
              width="600px"
