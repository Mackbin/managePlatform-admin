    ...
    <el-main class="query_info">
        <el-form  :inline="true" status-icon  ref="contractData" label-width="100px" >
                ...
                <el-form-item label="字典状态：">
                  <el-select v-model="form.region" placeholder="字典状态">
    ...
    <el-main class="query_info">
       <el-row class="button_list">
         <!-- 添加 -->
          ...
          <!-- <el-button class="el-button el-button--small gap" type="warning">导出</el-button> -->
      </el-row>
      <el-table :data="tableData" style="width: 100%" :default-sort = "{prop: 'date', order: 'descending'}" @selection-change="handleSelectionChange">
        <el-table-column prop="date" label="字典编号" >
        </el-table-column>
        <el-table-column prop="name" label="字典名称" >
        </el-table-column>
        <el-table-column prop="address" label="字典类型">
        </el-table-column>
        ...
        <el-table-column prop="address" label="操作" width="250px">
          <template slot-scope="scope">
            <el-button
              ...
              <router-link :to="{path:'/dictDetails'}" style="padding:0 10px 0 10px">
                <el-button
                size="mini"
                type="success"
                >列表</el-button>
