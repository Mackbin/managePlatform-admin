        ...
        <div class="change_password">
            <el-form  ref="registerData" :model="registerData" status-icon :rules="rules" :label-position='labelPosition' label-width="110px" class="demo-ruleForm">
                <el-form-item label="用户名：" prop="username">
                    <el-input type="password" v-model="registerData.username" autocomplete="off" placeholder="请输入用户名"></el-input>
                </el-form-item>
                ...
                <el-form-item label="短信验证码：" prop="code">
                    <el-input class="validateNO" placeholder="输入短信验证码" v-model="registerData.code">
                    </el-input>
